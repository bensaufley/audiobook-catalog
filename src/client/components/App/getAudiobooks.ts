...
export type GetAudiobooksQuery = { __typename?: 'Query', getAudiobooks: Array<{ __typename?: 'Audiobook', id: string, name: string, authors: Array<{ __typename?: 'Author', id: string, lastName: string, firstName: string }> }> };
...
export function useGetAudiobooksQuery(options: Omit<Urql.UseQueryArgs<GetAudiobooksQueryVariables>, 'query'> = {}) {
